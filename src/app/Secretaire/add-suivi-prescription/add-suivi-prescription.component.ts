...
@Component({
  selector: 'app-add-suivi-prescription',
  templateUrl: './add-suivi-prescription.component.html',
  styleUrls: ['./add-suivi-prescription.component.css']
})
export class AddSuiviPrescriptionComponent implements OnInit {

...
@Component({
  selector: 'app-edit-soin-prescription',
  templateUrl: './edit-soin-prescription.component.html',
  styleUrls: ['./edit-soin-prescription.component.css']
})
export class EditSoinPrescriptionComponent implements OnInit {
  ...
  editTest(idT: number, idP: number) {
    this.router.navigate(["/editTestSoin", idT, idP]);
    console.log(idT)
  }

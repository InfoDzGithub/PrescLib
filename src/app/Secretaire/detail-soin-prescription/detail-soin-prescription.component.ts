...
@Component({
  selector: 'app-detail-soin-prescription',
  templateUrl: './detail-soin-prescription.component.html',
  styleUrls: ['./detail-soin-prescription.component.css']
})
export class DetailSoinPrescriptionComponent implements OnInit {

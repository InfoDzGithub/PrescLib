...
@Component({
  selector: 'app-edit-test-soin',
  templateUrl: './edit-test-soin.component.html',
  styleUrls: ['./edit-test-soin.component.css']
})
export class EditTestSoinComponent implements OnInit {
  ...
  infoBox(message: string) {
    ...
    if (confirm(message)) {
      this.router.navigate(["/editSoinPrescription", this.idP]);
